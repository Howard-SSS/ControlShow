...
extension WCFunctionListView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let view = UIView(frame: .init(x: 0, y: 0, width: tableView.width, height: height))
        return view
    }
...
extension WCFunctionListView {
    ...
    class ItemCell: UITableViewCell {
        ...
        lazy var iconImgV: UIImageView = {
            let iconImgV = UIImageView(frame: .init(x: 10, y: (contentView.height - 30) * 0.5, width: 30, height: 30))
            return iconImgV
        }()
        
        lazy var titleLab: UILabel = {
            let titleLab = UILabel(frame: .init(x: iconImgV.maxX + 10, y: (contentView.height - 25) * 0.5, width: 200, height: 25))
        ...
        lazy var hintImgV: UIImageView = {
            let hintImgV = UIImageView(frame: .init(x: titleLab.maxX, y: (contentView.height - 30) * 0.5, width: 30, height: 30))
